...
- Sources: CISA KEV, vendor security advisories, trusted security researchers.  
- These vulnerabilities are **actively exploited in the wild** as of May 2026.  
- If you cannot patch immediately, apply mitigations (isolation, access control, monitoring).  
- For zero‑days without a patch (e.g., CVE-2026-42897), implement vendor‑provided workarounds without delay.
